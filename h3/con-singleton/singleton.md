...
son objetos de negocio múltiples y altamente dinamicos, por lo que la aplicación del patron Singleton sobre ellas sería 
un antipatrón (Stateful Global Class)

¿Por que no se aplica Singleton en las clases base?
